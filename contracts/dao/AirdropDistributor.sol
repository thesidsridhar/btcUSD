...
// /**
//     @title BBL Airdrop Distributor
//     @notice Distributes BBL to veCRV holders that voted in favor of BBL's
//             initial Curve governance proposal, and to early users who interacted
//             with the protocol prior to token emissions.
//     @dev Airdropped BBL tokens are given as a locked position. Distribution
//          is via a merkle proof. The proof and script used to create are available
//          on Github: https://github.com/BBL-fi/airdrop-proofs
//  */
...
//         IBBLVault(vault).increaseUnallocatedSupply(amount);
//     }
